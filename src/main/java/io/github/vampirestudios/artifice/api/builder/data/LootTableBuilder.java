...
public final class LootTableBuilder extends TypedJsonBuilder<JsonResource<JsonObject>> {
	...
	public LootTableBuilder pool(Pool settings) {
		with("pools", JsonArray::new, pools -> pools.add(settings.build()));
		return this;
	}
	...
	public static final class Pool extends TypedJsonBuilder<JsonObject> {
		...
		public Pool entry(Entry settings) {
			with("entries", JsonArray::new, entries -> entries.add(settings.build()));
			return this;
		}
		 ...
		 */
		public Pool condition(ResourceLocation id, JsonObjectBuilder settings) {
			with("conditions", JsonArray::new, conditions -> conditions.add(settings.add("condition", id.toString()).build()));
			return this;
		}
		...
		public static final class Entry extends TypedJsonBuilder<JsonObject> {
			...
			public Entry child(Entry settings) {
				with("children", JsonArray::new, children -> children.add(settings.build()));
				return this;
			}
			 ...
			 * @see <a href="https://minecraft.gamepedia.com/Loot_table#Conditions" target="_blank">Minecraft Wiki</a>
			 */
			public Entry condition(ResourceLocation id, JsonObjectBuilder settings) {
				with("conditions", JsonArray::new, conditions ->
						conditions.add(settings.add("condition", id.toString()).build()));
				return this;
			}
