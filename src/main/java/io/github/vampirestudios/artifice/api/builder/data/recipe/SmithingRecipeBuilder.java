...
public class SmithingRecipeBuilder extends RecipeBuilder<SmithingRecipeBuilder> {
	 ...
	 * @return this
	 */
	public SmithingRecipeBuilder multiBase(MultiIngredientBuilder settings) {
		root.add("base", settings.build());
		return this;
	}
	 ...
	 * @return this
	 */
	public SmithingRecipeBuilder multiAddition(MultiIngredientBuilder settings) {
		root.add("addition", settings.build());
		return this;
	}
