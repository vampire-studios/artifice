...
public class DiskFeatureConfigBuilder extends FeatureConfigBuilder {
	...
	public DiskFeatureConfigBuilder halfHeight(int halfHeight) {
		if (halfHeight > 4)
			throw new IllegalArgumentException("halfHeight can't be higher than 4! Found " + halfHeight);
		if (halfHeight < 0)
			throw new IllegalArgumentException("halfHeight can't be smaller than 0! Found " + halfHeight);
