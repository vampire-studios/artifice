...
public class FeatureSizeBuilder extends TypedJsonBuilder<JsonObject> {
	...
	public FeatureSizeBuilder minClippedHeight(int minClippedHeight) {
		if (minClippedHeight > 80)
			throw new IllegalArgumentException("minClippedHeight can't be higher than 80! Found " + minClippedHeight);
		if (minClippedHeight < 0)
			throw new IllegalArgumentException("minClippedHeight can't be higher than 0! Found " + minClippedHeight);
	...
	public static class TwoLayersFeatureSizeBuilder extends FeatureSizeBuilder {
		...
		public TwoLayersFeatureSizeBuilder lowerSize(int lowerSize) {
			if (lowerSize > 16)
				throw new IllegalArgumentException("lowerSize can't be higher than 16! Found " + lowerSize);
			if (lowerSize < 0)
				throw new IllegalArgumentException("lowerSize can't be higher than 0! Found " + lowerSize);
		...
		public TwoLayersFeatureSizeBuilder upperSize(int upperSize) {
			if (upperSize > 16)
				throw new IllegalArgumentException("upperSize can't be higher than 16! Found " + upperSize);
			if (upperSize < 0)
				throw new IllegalArgumentException("upperSize can't be higher than 0! Found " + upperSize);
	...
	public static class ThreeLayersFeatureSizeBuilder extends FeatureSizeBuilder {
		...
		public ThreeLayersFeatureSizeBuilder upperLimit(int upperLimit) {
			if (upperLimit > 80)
				throw new IllegalArgumentException("upperLimit can't be higher than 80! Found " + upperLimit);
			if (upperLimit < 0)
				throw new IllegalArgumentException("upperLimit can't be higher than 0! Found " + upperLimit);
		...
		public ThreeLayersFeatureSizeBuilder middleSize(int middleSize) {
			if (middleSize > 16)
				throw new IllegalArgumentException("middleSize can't be higher than 16! Found " + middleSize);
			if (middleSize < 0)
				throw new IllegalArgumentException("middleSize can't be higher than 0! Found " + middleSize);
