...
public final class IdUtils {
	 ...
	 */
	public static ResourceLocation wrapPath(String prefix, ResourceLocation id) {
		return wrapPath(prefix, id, "");
	}
	 ...
	 */
	public static ResourceLocation wrapPath(ResourceLocation id, String suffix) {
